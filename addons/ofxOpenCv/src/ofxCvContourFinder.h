...
//by sena//////
    ...
    virtual vector<float>  getCenterX( float x, float y, float w, float h );
    virtual vector<float>  getCenterY( float x, float y, float w, float h );
    vector<float>  centerX_of_Blobs;
    vector<float>  centerY_of_Blobs;
    int getSize();
